...
function BedSheet({category}) {
  ...
  return (
    <section className="pb-12 pt-[120px] px-3 max-h-full ">
        <h2
          className={` relative text-3xl font-bold font-poppins text-center mb-12 before:content-['Bed_Sheet'] before:absolute before:text-maroon before:text-[18px] md:before:text-[18px] before:top-[-20px] before:left-1/2 before:-translate-x-1/2 before:translate-y-[50px]`}
        >
