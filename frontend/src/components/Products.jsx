...
const Products = () => {
  ...
  const bedsheet = [
    ...
    { id: 3, name: "Product 3", price: "$50", img: "https://via.placeholder.com/150" }
  ]

  return (
    <section className="py-12 bg-gray-100">
  <div className="container mx-auto px-6">
    <h2 className="text-3xl font-bold font-poppins text-center mb-12">Our Products</h2>

    {/* Saree Section */}
    <div className="mb-12">
      <h2 className="text-3xl font-semibold font-poppins flex justify-between text-center mb-8">
        <span>Saree</span>
        <span className="text-xl"><Link to="/sarees">View All</Link></span>
      </h2>
    ...
    <div>
      <h2 className="text-3xl font-semibold font-poppins flex justify-between text-center mb-8">
      <span>Bed Sheet</span>
      <span className="text-xl"><Link to="/bedsheet">View All</Link></span>
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-center">
